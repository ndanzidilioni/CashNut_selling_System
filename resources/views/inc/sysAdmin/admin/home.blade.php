...
@section('contents')
  <div class="dash-widget-info text-left">
                                ...
                                <strong>!!!</strong> Admin <a href="#" class="alert-link">  Added</a>  successfully.
                                ...
                                <strong>!!!</strong> Admin <a href="#" class="alert-link"> Not Added</a>  successfully.   something went wrong
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-9 text-right m-b-20">
            <a class="btn btn-primary float-right btn-rounded" href="{!! route('manage', ['id'=>Crypt::encrypt(1)]) !!}"><i class="fa fa-plus"></i> Add Admin</a>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
