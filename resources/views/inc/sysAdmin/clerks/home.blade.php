...
@section('contents')
                             ...
                             <div class="dash-widget-info text-left">
                                ...
                                <strong>!!!</strong> clerk <a href="#" class="alert-link">  Added</a>  successfully.
                                ...
                                <strong>!!!</strong> clerk <a href="#" class="alert-link"> Not Added</a>  successfully.   something went wrong
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">×</span>
                                </button>
                            </div>
    ...
    <div class="row">
        <div class="col-sm-4 col-3">
            <h4 class="page-title">Clerks</h4>
        </div>
        <div class="col-sm-8 col-9 text-right m-b-20">
            <a class="btn btn-primary float-right btn-rounded" href="{!! route('manage', ['id'=>Crypt::encrypt(3)]) !!}"></i> Add Clerk</a>
        </div>
    </div>
