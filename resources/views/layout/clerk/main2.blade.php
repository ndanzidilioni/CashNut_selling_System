    ...
    <div class="header">
        ...
        <ul class="nav user-menu float-right">
            <li class="nav-item dropdown d-none d-sm-block">
                <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><i class="fa fa-bell-o"></i> <span class="badge badge-pill bg-danger float-right">3</span></a>
                        ...
                        <ul class="notification-list">
                            <li class="notification-message">
                                <a href="activities.html">
                                    <div class="media">
                                        <span class="avatar">
                                            <img class="img-fluid" alt="John Doe" src="assets/img/user.jpg">
                                        </span>
